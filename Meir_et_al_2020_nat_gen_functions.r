...
# This function downloads tables used for HiC analysis from our repositories
#################################################################################################################
...
for (i in hic_table_nms){
download.file(url = paste0( "http://www.wisdom.weizmann.ac.il/~zoharme/Meir_et_al_NatGen_2020/",i),
			  destfile = paste0(base_dir,i))}
}
#################################################################################################################
#################################################################################################################
#################################################################################################################
...
for (i in methylation_table_nms){
download.file(url = paste0( "http://www.wisdom.weizmann.ac.il/~zoharme/Meir_et_al_NatGen_2020/",i),
			  destfile = paste0(base_dir,i))}
}
#################################################################################################################
